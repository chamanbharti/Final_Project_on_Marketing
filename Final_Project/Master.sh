...
#python <scriptname> followed by all of the required input arguments in the correct order as explained above. 
# You must be in the directory your python script is located in to run it, otherwise you can provide the filepath. 


#For this project:
python src/Ads.py data/SalesDataA.xlsm Sales data/SalesDataA.xlsm Ads Figure1.pdf

python src/TypeCustomers.py data/SalesDataA.xlsm Sales Figure2.pdf 
